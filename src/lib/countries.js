...
//
// The Middle East / North Africa block is pinned to the top because the
// bulk of the audience is taking the Arab Board exam (Iraq + Qatar first).
// Every other country follows alphabetically. The picker searches by
// name, dial code, or ISO code, so the long tail is still easy to find.
