 ...
 * (read at render time from whoever is currently authenticated), so a leak
 * is traceable to a specific, revocable user. Rendered once at the app root
 * with `position: fixed` so it covers every screen including the full-screen
 * image lightbox. `pointer-events: none` means it never blocks interaction;
 * a high z-index keeps it above enlarged images.
 */
